...
class ChatsAdmin extends StatefulWidget {

  final String BookingID;
  final String service_option_id;
  final String customer_id;
  final String hero_id;
  ChatsAdmin(this.BookingID,this.service_option_id,this.customer_id,this.hero_id, {Key key}): super(key: key);
  @override
  _ChatsAdminState createState() => _ChatsAdminState();
}

class _ChatsAdminState extends State<ChatsAdmin> {
                ...
                Padding(
                  ...
                  child: StreamBuilder(
                      stream: FirebaseFirestore.instance.collection('chat')
                          .where('customer_id',isEqualTo: widget.hero_id)
                          .where('hero_id',isEqualTo: 'admin')
          ...
          onPressed: () async {
            ...
            var bookingSnapshot = await FirebaseFirestore.instance.collection("booking").doc(BookingID).get();
              ...
              await db.collection('chat').add({
                ...
                'hero_id':'admin',
                'hero_name':'Support Team',
                'customer_id':bookingSnapshot.get('hero_id'),
                'customer_name':bookingSnapshot.get('hero_name'),

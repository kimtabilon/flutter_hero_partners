...
import 'package:hero_partners/pages/manage_schedule.dart';
import 'package:hero_partners/pages/preferred_location.dart';
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        StreamBuilder<QuerySnapshot>(
                          stream: getUserAddressSnapshots(context),
                          builder: (context, addresssnapshot) {
                              ...
                              switch (snapshot.connectionState) {
                                ...
                                default:
                                  return InkWell(
                                    onTap:() {
                                        if(addresssnapshot.data.docs[0].get('province') != ""){
                                          Navigator.push(
                                              context,
                                              MaterialPageRoute(builder: (context) => PreferredLocation()));
                                        }else{
                                          Toast.show("Please update your profile address.", context, duration: Toast.LENGTH_LONG, gravity:  Toast.BOTTOM);
                                        }
                                    },
                                    child:
                                    Row(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Switch(
                          value: snapshot.data.docs.isEmpty
                              ? isSwitchedAuto
                              : snapshot.data.docs[0].get('auto_confirm'),
                          onChanged: (value){
                            setState(() async {
...
Stream<QuerySnapshot> getUserAddressSnapshots(BuildContext context) async* {
  final uid = await Provider.of(context).auth.getCurrentUID();
